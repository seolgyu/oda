					...
					<div class="row g-3 align-items-center">
						<div class="col-12 col-lg-6">
							<div class="btn-group glass-btn-group">
								<button type="button" class="btn btn-outline-light btnStatus ${empty status ? 'active' : ''} btn-sm px-3" data-status="">전체</button>
								<button type="button" class="btn btn-outline-light btnStatus ${status == '진행' ? 'active' : ''} btn-sm px-3" data-status="진행">진행중</button>
								<button type="button" class="btn btn-outline-light btnStatus ${status == '진행예정' ? 'active' : ''} btn-sm px-3" data-status="진행예정">진행예정</button>
								<button type="button" class="btn btn-outline-light btnStatus ${status == '종료' ? 'active' : ''} btn-sm px-3" data-status="종료">종료</button>
							</div>
						</div>	
							...
							<form name="searchForm" method="get">
						       ...
						       <div class="input-group search-wrapper">
						    	...
						    	<span class="material-icons-round text-white-25 mt-2" onclick="searchEvent();" style="cursor: pointer;">search</span> 
