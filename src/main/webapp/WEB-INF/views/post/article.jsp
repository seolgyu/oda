                                                ...
                                                <div class="carousel-inner rounded-3 overflow-hidden">
                                                    <c:forEach var="fileDto" items="${dto.fileList}" varStatus="status">
                                                        <div class="carousel-item ${status.first ? 'active' : ''}">
                                                            <div class="image-wrapper d-flex justify-content-center align-items-center bg-dark bg-opacity-25" style="height: 500px;">
                                                                <c:choose>
                                                                    ...
                                                                    <c:otherwise>
                                                                        <img src="${pageContext.request.contextPath}/uploads/photo/${fileDto.filePath}" class="d-block" style="max-width: 100%; max-height: 100%; object-fit: contain;" alt="Post Image">
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </div>
                                                        </div>
