...
<body class="bg-background-dark text-white">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <nav aria-label="breadcrumb">	
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/notice/list">공지사항 리스트</a></li>
                ...
                <div class="view-card">
                    ...
                    <div class="navigation-links">
                        <c:if test="${not empty prevDto}">
                            <a class="nav-item-row" href="${pageContext.request.contextPath}/notice/article?${query}&num=${prevDto.notice_num}">
                        ...
                        <c:if test="${not empty nextDto}">
                            <a class="nav-item-row" href="${pageContext.request.contextPath}/notice/article?${query}&num=${nextDto.notice_num}">
                                <span class="nav-label">
    ...
    $(function() {
        $('button.btnSendBoardLike').click(function() {
            ...
            let url = '${pageContext.request.contextPath}/notice/insertBoardLike';
